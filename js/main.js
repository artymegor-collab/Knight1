...
window.sprites={
  knightIdle:new SpriteSheet('assets/knight.png', 6), knightRun: new SpriteSheet('assets/knight_run.png', 6), goblin:new SpriteSheet('assets/goblin.png'), archer:new SpriteSheet('assets/archer.png'), boss:new SpriteSheet('assets/boss.png') 
};
